/********************************************************************
*
*   File: dataclasses_global.h    Class:
*
...
*
********************************************************************/
#ifndef DATACLASSES_GLOBAL_H
#define DATACLASSES_GLOBAL_H

#include <QtCore/qglobal.h>

#if defined(DATACLASSES_LIBRARY)
#  define DATACLASSESSHARED_EXPORT Q_DECL_EXPORT
#else
#  define DATACLASSESSHARED_EXPORT Q_DECL_IMPORT
#endif

#endif // DATACLASSES_GLOBAL_H
